    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            if(move_uploaded_file($_FILES['fileUpload']['tmp_name'], 'uploads/' .$new_name)){
                 ...
                 */
                $sql = "INSERT INTO `users` (`username`, `password`, `first_name`, `last_name`, `address`, `email`, `phone`, `picture`) 
                        VALUES ('".$_POST['username']."', '".$_POST['password']."', '".$_POST['first_name']."', '".$_POST['last_name']."', '".$_POST['address']."', '".$_POST['email']."', '".$_POST['phone']."', '". $new_name."');";
